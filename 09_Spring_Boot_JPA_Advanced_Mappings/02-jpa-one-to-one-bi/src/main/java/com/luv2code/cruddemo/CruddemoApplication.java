...
//
		...
		// Create the instructor
		Instructor tempInstructor = new Instructor("Mickel", "J", "jmike@gmail.com");

		InstructorDetail tempInstructorDetail = new InstructorDetail("youtube.com/notfound404", "Love 2 sing !!!");
